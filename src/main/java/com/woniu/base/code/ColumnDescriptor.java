...
public class ColumnDescriptor {
	...
	private static Map<String, Class<?>> validationRules = Maps.newHashMap();
	...
	private static Map<String, String> labelMapping = Maps.newHashMap();

	static {
		labelMapping.put("id", "ID");
		labelMapping.put("create_date", "创建时间");
		labelMapping.put("update_date", "更新时间");
	}
	...
	public String getDefaultValueCode() {
		...
		if (isTimestamp()) {
			if ("CURRENT_TIMESTAMP".equals(defaultValue)) {
				return "DateTime.now()";
			}else if ("0000-00-00 00:00:00".equals(defaultValue)) {
				return "null";
			}
		}
